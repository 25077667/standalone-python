...
export LD_LIBRARY_PATH="${LD_LIBRARY_PATH}:/opt/shared_libraries/lib:"
...
./configure --build="$gnuArch" --enable-loadable-sqlite-extensions \
    --enable-optimizations --enable-option-checking=fatal --enable-shared --enable-profiling \
    --with-lto=full --with-system-expat --without-ensurepip \
